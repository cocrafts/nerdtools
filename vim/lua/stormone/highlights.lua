...
return {
  ...
  Search = { fg = C.darker_bg, bg = C.yellow },
  IncSearch = { fg = C.yellow, bg = C.darker_bg },
  HlSearchNear = { fg = C.darker_bg, bg = C.green },
  HlSearchLens = { fg = C.fg, bg = C.gray },
  HlSearchLensNear = { fg = C.darker_bg, bg = C.green },
  HlSearchFloat = { fg = C.darker_bg, bg = C.purple },
}
